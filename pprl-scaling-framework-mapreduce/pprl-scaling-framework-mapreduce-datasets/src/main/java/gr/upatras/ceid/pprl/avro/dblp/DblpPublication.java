 ...
 */
package gr.upatras.ceid.pprl.avro.dblp;  
...
public class DblpPublication extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder newBuilder() {
    return new gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder();
  }
  
  /** Creates a new DblpPublication RecordBuilder by copying an existing Builder */
  public static gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder newBuilder(gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder other) {
    return new gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder(other);
  }
  
  /** Creates a new DblpPublication RecordBuilder by copying an existing DblpPublication instance */
  public static gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder newBuilder(gr.upatras.ceid.pprl.avro.dblp.DblpPublication other) {
    return new gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DblpPublication>
    ...
    private Builder() {
      super(gr.upatras.ceid.pprl.avro.dblp.DblpPublication.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder other) {
      super(other);
    ...
    private Builder(gr.upatras.ceid.pprl.avro.dblp.DblpPublication other) {
            super(gr.upatras.ceid.pprl.avro.dblp.DblpPublication.SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'key' field */
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder setKey(java.lang.CharSequence value) {
    ...
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder clearKey() {
      key = null;
    ...
    /** Sets the value of the 'author' field */
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder setAuthor(java.lang.CharSequence value) {
    ...
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder clearAuthor() {
      author = null;
    ...
    /** Sets the value of the 'title' field */
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder setTitle(java.lang.CharSequence value) {
    ...
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder clearTitle() {
      title = null;
    ...
    /** Sets the value of the 'year' field */
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder setYear(java.lang.CharSequence value) {
    ...
    public gr.upatras.ceid.pprl.avro.dblp.DblpPublication.Builder clearYear() {
      year = null;
