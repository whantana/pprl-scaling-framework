 ...
 */
public class RecordPairSimilarityCombiner extends Reducer<LongWritable, TextArrayWritable,LongWritable,TextArrayWritable> {
    ...
    protected void reduce(LongWritable key, Iterable<TextArrayWritable> values, Context context) throws IOException, InterruptedException {
        ...
        switch (list.size()) {
            ...
            case 2:
                ...
                context.getCounter(CommonKeys.PAIRS_DONE_KEY,"combine").increment(1);
                break;
            default:
