...
public class Csv2AvroTest {
    ...
    public void test1() throws IOException, DatasetException {
        ...
        final Path p = DatasetsUtil.csv2avro(fs,schema,new Path(fs.getWorkingDirectory(),"data_small.csv"));
    ...
    public void test2() throws IOException, DatasetException {
        ...
        final FileSystem fs = FileSystem.getLocal(new Configuration());
        final Path p = DatasetsUtil.csv2avro(fs,schema,new Path(fs.getWorkingDirectory(),"data_medium.csv"));
        LOG.info("Saved at path {} ", p);
    }
    ...
    public void test3() throws IOException, DatasetException {
        ...
        final FileSystem fs = FileSystem.getLocal(new Configuration());
        final Path p = DatasetsUtil.csv2avro(fs,schema,new Path(fs.getWorkingDirectory(),"data_big.csv"));
        LOG.info("Saved at path {} ", p);
    }
